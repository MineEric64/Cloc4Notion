    ...
    internal class Unzip : IDisposable
    {
        ...
        public void ExtractToDirectory(string directoryName)
        {
            ...
            for (int index = 0; index < Entries.Length; index++)
            {
                ...
                AlphaDirectory.CreateDirectory(dirName);
        ...
        public void Extract(string fileName, string outputFileName)
        {
            ...
            outputFileName = MainWindow.GetValidPath(outputFileName);

            using (var outStream = AlphaFile.Create(outputFileName))
            {
                Extract(entry, outStream);
            }

            var fileInfo = new AlphaFileInfo(outputFileName);
            ...
            AlphaFile.SetLastWriteTime(outputFileName, entry.Timestamp);
        }
